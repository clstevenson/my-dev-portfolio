...
const projectData = [
  ...
  },
  {
    ...
    description: 'Development of RESTful routes intended for use in a social network. API routes are created for users to post their thoughts, react to other posts, and make Friend requests.',
  ...
  },
  {
    id: crypto.randomUUID(),
    title: 'Tech Blog',
    description: 'A CMS-style blog site where users can create blog posts and comment on the posts of others. Users must create an account to post blogs and comments and to read other posts in their entirety. Once logged in, users have the ability to edit or delete their own posts and comments.',
    notes: 'This is a full-stack app that follows the MVC organizational structure and uses MySQL (with Sequelize as the ORM) and Handlebars as a templating system. Bulma was used as a CSS framework.',
  ...
  },
  {
    ...
    description: 'A Node.js command line app to perform CRUD operations on a database used to track employees and departments.',
    notes: 'MySQL literals were used for all CRUD operations; in other words, no ORM was used in this project.',
  ...
  },
  {
    ...
    description: 'A front-end app that interfaces to two third-party APIs to retrieve and display data about superheroes, and funny memes related to those characters.',
    notes: 'This was my first major project involving asynchronous functions, and my first major collaboration as well. We fetched data from two APIs: superheroapi.com and giphy.com. I was responsible for the fetches and display of the giphy.com data. I have forked the project to my GitHub for further work.',
  ...
  },
  {
    ...
    description: 'This is a 2000-word tutorial on the use of regular expressions in JavaScript',
    notes: 'The ability to explain something well requires a deeper understanding of the topic. This tutorial, which could also serve as a reference, explains some of the basics of regular expressions and some of the most important methods of using them in JavaScript programs. Many code snippets are shown as well as references for further study.',
    repoURL: 'https://gist.github.com/clstevenson/a40c854e46ed28dda567de71129bc1c0',
    deployedURL: '',
  ...
  },
  {
    ...
    description: 'At the present time I have written 38 Lambda functions (over 1000 lines of code) to perform a variety of statistical calculations in Excel',
    notes: "With the introduction of the LAMBDA and LET functions, Excel's spreadsheet language -- the language used to create cell formulas in Excel -- has become much more powerful; Turing-complete, in fact. Lambda functions can be used in any Excel worksheet or even in the Excel online web applications. Some MS engineers have created an add-in, now called Excel Labs, whereby users can share Lambda functions through GitHub Gists. I have recently made my functions publicly available to all; I also use them in an add-in I am developing (not yet public) for more sophisticated data analysis in Excel. The embedded video is a rather long introduction to using Lambda functions in Excel and why you would want to do so; note that at the time the video was made, the Excel Labs add-in was called the Advanced Formula Environment add-in.",
    repoURL: 'https://gist.github.com/clstevenson/aadeb15b628e815fea18e986d49bed87',
    deployedURL: '',
